...
export declare class PipelineProcessor extends WorkerHost {
    ...
    constructor(prisma: PrismaService, aiProvidersService: AiProvidersService, orchestrator: PipelineOrchestrator, assetService: AssetService, episodeService: EpisodeService, storyboardService: StoryboardService, anchorService: AnchorService, videoService: VideoService, assemblyService: AssemblyService, ws: WsGateway);
