...
let AiProvidersController = class AiProvidersController {
    ...
    remove(req, id) { return this.service.remove(req.user.sub, id); }
...
], AiProvidersController.prototype, "list", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", void 0)
], AiProvidersController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", void 0)
], AiProvidersController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AiProvidersController.prototype, "remove", null);
__decorate([
